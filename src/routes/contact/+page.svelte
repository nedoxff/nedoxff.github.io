		...
		<div class="mt-10 flex min-h-max flex-col items-stretch p-5 md:ml-10 md:mt-5">
			...
			>
				...
				>
					...
					>
					<span class="ml-4 mr-4 text-3xl font-bold text-light">@nedoxff</span>
				</a>
				<a
				...
				>
					...
					>
					<span class="ml-4 mr-4 text-3xl font-bold text-light dark:text-dark">nedoxff</span>
				</a>
				<a
					href="https://twitter.com/nedodraws"
					class="inline-flex h-20 w-auto max-w-20 items-center overflow-hidden rounded-full bg-[#08a0e9] transition-[max-width] duration-700 ease-in-out-quad hover:max-w-full"
				>
					<span class="ml-4 flex h-16 min-w-12 max-w-12 items-center"
						><img src="/social/twitter.svg" alt="twitter icon" /></span
					>
					<span class="ml-4 mr-4 text-3xl font-bold text-light">@nedodraws</span>
				</a>
				<a
				...
				>
					<span class="ml-4 flex h-16 min-w-12 max-w-12 items-center dark:invert"
						><img class="invert" src="/social/mail.png" alt="mail icon" /></span
					>
					<span class="ml-4 mr-4 text-3xl font-bold text-light dark:text-dark"
